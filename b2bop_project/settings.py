...
# Use environment variable if available, otherwise fallback to Atlas URI
MONGO_URI = os.getenv(
    "MONGO_URI",
    "mongodb+srv://petchimuthukumar_db_user:MBPUOoEw5R4y38UC@cluster0.jt8o2hl.mongodb.net/user_management?retryWrites=true&w=majority&appName=Cluster0"
)
...
# Optional: dictionary config for django-mongoengine
MONGODB_DATABASES = {
    'default': {
